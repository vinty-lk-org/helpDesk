...
public class SystemUserDaoImpl implements SystemUserDao {
    ...
    private static final String SQL_DELETE_SYSTEM_USER = "DELETE FROM system_users WHERE (id = ?)";
    private static final String SQL_FIND_EMAIL = "{ ? = call system_user_findby_email(?)}";
    private static final String SQL_SAVE_USERS_PRIVILEGES = "INSERT INTO users_privileges (user_id, privilege_id) VALUES (?, ?);";
    private static final String SQL_DELETE_USERS_PRIVILEGES = "DELETE FROM users_privileges WHERE (user_id = ?)";

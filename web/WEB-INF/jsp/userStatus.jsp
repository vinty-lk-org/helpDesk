...
<form name="privilege" id="privilege" action="${pageContext.request.contextPath}/user/Update" method="post">
    <div class="grid-container">
        <div class="grid-x grid-padding-x">
            <div class="medium-3 cell">
            </div>
            <div class="medium-3 cell">
                <select name="privilegeNameId" id="privilegeNameId">
                    <c:forEach items="${requestScope.privilege}" var="privilege">
